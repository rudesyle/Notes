...
app.dataservice = (function(breeze, logger) {
    ...
    var serviceName = 'breeze/notebook'; // route to the same origin Web Api controller
    ...
    function getAllNotebooks(includeArchived) {
        var query = breeze.EntityQuery
            .from("GetAllNotebooks")
            .orderBy("Name");

        /*if (!includeArchived) { // exclude archived ThyNotebooks
            // add filter clause limiting results to non-archived ThyNotebooks
    ...
    function createNotebook(initialValues) {
        return manager.createEntity('Notebook', initialValues);
    }
    ...
    function saveChanges() {
        ...
        function saveSucceeded(saveResult) {
            logger.success("# of ThyNotebooks saved = " + saveResult.entities.length);
        ...
        function saveFailed(error) {
            ...
            if (error.entityErrors) {
                ...
                reason =
                    ...
                    "may have deleted one or all of the notebook." +
